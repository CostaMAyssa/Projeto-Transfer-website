  ...
  return <footer className="bg-white text-black py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          {/* Quick Links */}
          <div className="space-y-8">
            <h3 className="text-xl font-light tracking-wide border-b border-gray-200 pb-2">Quick Links</h3>
            <ul className="space-y-4">
              <li>
                <Link to="/about" className="text-gray-600 hover:text-brand transition-colors flex items-center gap-2 font-light">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-600 hover:text-brand transition-colors flex items-center gap-2 font-light">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-gray-600 hover:text-brand transition-colors flex items-center gap-2 font-light">
                  Careers
                </Link>
              </li>
              <li>
                <Link to="/partners" className="text-gray-600 hover:text-brand transition-colors flex items-center gap-2 font-light">
                  Partners
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-gray-600 hover:text-brand transition-colors flex items-center gap-2 font-light">
                  Services
                </Link>
              </li>
            </ul>
          ...
          {/* Contact Information */}
          <div className="space-y-8">
            <h3 className="text-xl font-light tracking-wide border-b border-gray-200 pb-2">Contact Us</h3>
            <ul className="space-y-6">
              <li className="flex items-start gap-3">
                <Mail size={18} className="text-[#F35B62] min-w-[18px] mt-1" />
                <a href="mailto:hello@aztransfergroup.com" className="text-gray-600 hover:text-brand transition-colors font-light">
                  hello@aztransfergroup.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Phone size={18} className="text-[#F35B62] min-w-[18px] mt-1" />
                <a href="tel:+13478487765" className="text-gray-600 hover:text-brand transition-colors font-light">
                  +1 (347) 848-7765
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="https://wa.me/13478487765" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-brand transition-colors font-light">
          ...
          {/* Newsletter */}
          <div className="space-y-8">
            <h3 className="text-xl font-light tracking-wide border-b border-gray-200 pb-2">Newsletter</h3>
            <p className="text-gray-600 font-light">
              Subscribe to our newsletter to receive updates and promotions.
            </p>
            <form className="flex flex-col sm:flex-row gap-2">
              <input type="email" placeholder="Your Email Address" className="bg-gray-100 border border-gray-200 rounded-none px-4 py-2 focus:outline-none focus:ring-1 focus:ring-brand text-black" />
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-8 text-sm">
              <Link to="/privacy-policy" className="text-gray-500 hover:text-brand transition-colors font-light">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-gray-500 hover:text-brand transition-colors font-light">
                Terms of Service
              </Link>
              <Link to="/sitemap" className="text-gray-500 hover:text-brand transition-colors font-light">
                Sitemap
              </Link>
            </div>
          </div>
