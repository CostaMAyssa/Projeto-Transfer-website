  ...
  return <footer className="bg-white text-black py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          {/* Quick Links */}
          <div className="space-y-8">
            <h3 className="text-xl font-medium tracking-wide border-b border-gray-200 pb-2">Quick Links</h3>
            <ul className="space-y-4">
              <li>
                <Link to="/about" className="text-gray-600 hover:text-brand transition-colors flex items-center gap-2 font-normal">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-600 hover:text-brand transition-colors flex items-center gap-2 font-normal">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-gray-600 hover:text-brand transition-colors flex items-center gap-2 font-normal">
                  Careers
                </Link>
              </li>
              <li>
                <Link to="/partners" className="text-gray-600 hover:text-brand transition-colors flex items-center gap-2 font-normal">
                  Partners
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-gray-600 hover:text-brand transition-colors flex items-center gap-2 font-normal">
                  Services
                </Link>
              </li>
            </ul>
          ...
          {/* Contact Information */}
          <div className="space-y-8">
            <h3 className="text-xl font-medium tracking-wide border-b border-gray-200 pb-2">Contact Us</h3>
            <ul className="space-y-6">
              <li className="flex items-start gap-3">
                <Mail size={18} className="text-[#F35B62] min-w-[18px] mt-1" />
                <a href="mailto:hello@aztransfergroup.com" className="text-gray-600 hover:text-brand transition-colors font-normal">
                  hello@aztransfergroup.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Phone size={18} className="text-[#F35B62] min-w-[18px] mt-1" />
                <a href="tel:+13478487765" className="text-gray-600 hover:text-brand transition-colors font-normal">
                  +1 (347) 848-7765
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="https://wa.me/13478487765" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-brand transition-colors font-normal">
          ...
          {/* Newsletter */}
          <div className="space-y-8">
            <h3 className="text-xl font-medium tracking-wide border-b border-gray-200 pb-2">Newsletter</h3>
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              ...
              <Button type="submit" className="bg-brand hover:bg-brand-600 text-white font-normal">
                Subscribe
              </Button>
            </form>
          </div>
