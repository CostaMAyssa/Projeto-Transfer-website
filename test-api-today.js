...
console.log('🔍 Testando API com data de hoje...');
console.log('===================================');

const testFlightAPIToday = async () => {
  ...
  console.log('📋 Dados de teste (hoje):', testData);
  ...
  try {
    ...
    if (data.success && data.flight_found) {
      ...
      console.log('❌ Voo não encontrado para hoje');
